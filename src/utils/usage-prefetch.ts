...
const USAGE_WIDGET_REQUIREMENTS: Record<string, UsageFieldRequirement[]> = {
    ...
    'kimi-weekly-usage': [{ field: 'kimiWeeklyUsage' }],
    'kimi-monthly-usage': [{ field: 'kimiMonthlyUsage' }],
...
function pickDefinedUsageFields(data: UsageData | null | undefined): Partial<UsageData> {
    return {
        ...
        ...(data?.kimiWeeklyUsage !== undefined ? { kimiWeeklyUsage: data.kimiWeeklyUsage } : {}),
        ...(data?.kimiWeeklyResetAt !== undefined ? { kimiWeeklyResetAt: data.kimiWeeklyResetAt } : {}),
        ...(data?.kimiMonthlyUsage !== undefined ? { kimiMonthlyUsage: data.kimiMonthlyUsage } : {}),
        ...(data?.kimiMonthlyResetAt !== undefined ? { kimiMonthlyResetAt: data.kimiMonthlyResetAt } : {}),
