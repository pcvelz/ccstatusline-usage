...
export const WIDGET_MANIFEST: WidgetManifestEntry[] = [
    ...
    { type: 'block-reset-timer', create: () => new widgets.BlockResetTimerWidget() },
    { type: 'weekly-reset-timer', create: () => new widgets.WeeklyResetTimerWidget() },
    { type: 'kimi-weekly-usage', create: () => new widgets.KimiWeeklyUsageWidget() },
    { type: 'kimi-monthly-usage', create: () => new widgets.KimiMonthlyUsageWidget() },
